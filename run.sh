...
MAX_PACKS=1000000
total_sockets="1 2 4 8 12 16 24 32 48 64 128"
num_threads_per_socket=1
total_clients=4
num_port=1820
repetitions=20

salida=reuseport_sockets_stress_SOSched.csv
...
salida=reuseport_sockets_stress_EtitativeSched.csv
...
salida=reuseport_sockets_stress_All0Sched.csv
